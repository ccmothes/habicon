...
plot(suit_bin, col = c("white", "darkgreen"))
```
...
plot(corr_bin, col = c("white", "darkgreen"))
```
...
plot(patch$qwa, col = gradient_n_pal(brewer_pal("seq", palette = "Greens")(9))(seq(0, 1, length=100)), 
     legend = FALSE, axes = FALSE,
     main = "Quality-Weighted Area")

plot(patch$btwn, col = gradient_n_pal(brewer_pal("seq", palette = "Greens")(9))(seq(0, 1, length=100)), 
     legend = FALSE, axes = FALSE,
...
plot(suit_bin, axes = FALSE, legend = FALSE,  main = "Corridor Priority")
plot(corridor, col = rev(heat.colors(n = 100)), add = TRUE, axes = FALSE,
     legend = FALSE)
